    ...
    return (
        ...
        <section className="max-w-6xl mx-auto px-4 py-7 ">
          <div className="grid gap-4 grid-cols-12">
            ...
            <div className="col-span-12 lg:col-span-9 bg-white p-5 rounded-md shadow-md space-y-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:items-center  ">
                <h3 className="capitalize text-xl font-medium">total mentorships:</h3>
                <span className="text-2xl font-semibold">20</span>
              </div>
              <div className=" bg-lime-900 text-white p-5 rounded-md shadow-sm mt-10">
