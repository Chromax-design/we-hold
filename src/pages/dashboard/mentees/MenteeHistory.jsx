    ...
    <main className="bg-gray-50 sm:p-4">
      <section className="max-w-6xl mx-auto px-2 sm:px-4 py-7 ">
        <div className="grid gap-4 grid-cols-12">
          ...
          <div className="col-span-12 lg:col-span-9 bg-white p-2 sm:p-5rounded-md shadow-md space-y-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center mt-10">
              ...
              <div className="flex gap-4 text-center mt-5">
                ...
                <div>
                  <h3 className="font-bold text-2xl sm:text-3xl">{myMentors.length}</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:items-center  ">
              <h3 className="capitalize text-lg sm:text-xl font-medium">
                total mentorships:
              </h3>
              <span className="text-2xl font-semibold">{myMentors.length}</span>
            </div>
