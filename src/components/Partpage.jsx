...
const Partpage = () => {
  return (
    <div className="h-full hidden bg-[url('/images/King&QueenHD.jpg')] bg-cover bg-center relative lg:flex justify-center flex-col items-center p-5 sm:p-10 max-md:py-10">
