...
const Success = ({ message, img, link }) => {
  return (
    <div className="w-full min-h-screen bg-[url('/images/bg-gradient.jpg')] backdrop-blur-lg bg-cover pt-24 pb-20  p-3 sm:px-4">
      <div className="max-w-lg mx-auto p-3 sm:p-8 shadow-xl bg-white rounded-lg">
        ...
        <h1 className="font-semibold text-center mb-5">{message}</h1>
        <Link
