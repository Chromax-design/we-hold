      ...
      {user?.role !== "mentor" && (
        <div className="relative group">
          ...
          <div
            ...
            } max-lg:block lg:overflow-hidden lg:absolute lg:top-12 lg:-left-full lg:min-w-[750px] lg:hidden group lg:group-hover:block rounded-md p-4 shadow-lg bg-white`}
          >
